...
import cn.astriva.common.basic.CurrentEntity;
...
public class JwtCurrentHandler implements HandlerInterceptor {
    ...
    public boolean preHandle(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull Object handler) throws Exception {
        ...
        current.setUserId(SaTokenUtil.getLoginIdAsLong());
        current.setUsername((String) SaTokenUtil.getExtra(SaTokenUtil.EXTRA_USERNAME));
        current.setDeptId(((Number) SaTokenUtil.getExtra(SaTokenUtil.EXTRA_DEPT_ID)).longValue());
        current.setNickname((String) SaTokenUtil.getExtra(SaTokenUtil.EXTRA_NICKNAME));
